...
var defaultFlagValues = map[string]interface{}{
	"gitops-webhook-secret":  "Auto-generated by kam if not user-overwritten", // Auto-generated by kam if not user-overwritten, no ""
	"output":                 "\"./gitops\"",
	"prefix":                 "\"\"",
	"dockercfgjson":          "\"~/.docker/config.json\"",
	"image-repo":             "Default values is internal registry", // Default values is internal registry, no ""
	"overwrite":              "\"false\"",
	"service-webhook-secret": "Auto-generated by kam if not user-overwritten", // Auto-generated by kam if not user-overwritten, no ""
